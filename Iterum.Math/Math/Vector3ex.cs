    ...
    public static class Vector3ex
    {
        ...
        internal static Vector3ex.Information GetInformation(IList<Vector3> points, float epsilon)
        {
            ...
            for (int j = 0; j < count; j++)
            {
                ...
                num16 = information.Direction[0].Dot(vector);
                float num17 = (vector - num16 * information.Direction[0]).magnitude;
                if (num17 > num15)
                {
                    num15 = num17;
            ...
            num16 = information.Direction[0].Dot(information.Direction[1]);
            information.Direction[1] -= num16 * information.Direction[0];
            ...
            for (int k = 0; k < count; k++)
            {
                ...
                float num17 = information.Direction[2].Dot(value);
                float num19 = Mathf.Sign(num17);
                num17 = Mathf.Abs(num17);
                if (num17 > num15)
                {
                    num15 = num17;
                    num18 = num19;
            ...
            information.ExtremeCCW = (num18 > 0f);
            return information;
        }
