...
public static class Matrix4x4ex
{
    ...
    {
        float num = angleInDegrees * 0.0174532924f;
    ...
    public static void CreateRotationAngleAxis(float angleInDegrees, Vector3 rotationAxis, out Matrix4x4 matrix)
    {
        ...
        float num4 = 1f - num2;
        float num5 = normalized.x * normalized.x;
        float num6 = normalized.y * normalized.y;
        float num7 = normalized.z * normalized.z;
        float num8 = normalized.x * normalized.y * num4;
        float num9 = normalized.x * normalized.z * num4;
        float num10 = normalized.y * normalized.z * num4;
        float num11 = normalized.x * num3;
        float num12 = normalized.y * num3;
        float num13 = normalized.z * num3;
        matrix.m00 = num5 * num4 + num2;
        matrix.m01 = num8 - num13;
        matrix.m02 = num9 + num12;
        matrix.m10 = num8 + num13;
        matrix.m11 = num6 * num4 + num2;
        matrix.m12 = num10 - num11;
        matrix.m20 = num9 - num12;
        matrix.m21 = num10 + num11;
        matrix.m22 = num7 * num4 + num2;
        matrix.m30 = 0f;
        matrix.m31 = 0f;
        matrix.m32 = 0f;
        matrix.m03 = 0f;
    ...
    public static void CreateRotationAngleUnitAxis(float angleInDegrees, Vector3 normalizedAxis, out Matrix4x4 matrix)
    {
        ...
        float num3 = Mathf.Sin(num);
        float num4 = 1f - num2;
        float num5 = normalizedAxis.x * normalizedAxis.x;
        float num6 = normalizedAxis.y * normalizedAxis.y;
        float num7 = normalizedAxis.z * normalizedAxis.z;
        float num8 = normalizedAxis.x * normalizedAxis.y * num4;
        float num9 = normalizedAxis.x * normalizedAxis.z * num4;
        float num10 = normalizedAxis.y * normalizedAxis.z * num4;
        float num11 = normalizedAxis.x * num3;
        float num12 = normalizedAxis.y * num3;
        float num13 = normalizedAxis.z * num3;
        matrix.m00 = num5 * num4 + num2;
        matrix.m01 = num8 - num13;
        matrix.m02 = num9 + num12;
        matrix.m10 = num8 + num13;
